...
def predict(cfg):
    ...
    train_data, train_label, test_data, test_label = model.data_preprocess(train_data, train_label, test_data, test_label)
    acc = model.get_accuracy(test_data,test_label)
    prediction = model.predict_prob(test_data)
